...
const links: NavLink[] = [
    { href: "/#philosophy", label: "Philosophy", hash: "#philosophy" },
    { href: "/#projects", label: "NetProphet", hash: "#projects" },
    { href: "/#vision", label: "Vision", hash: "#vision" },
    { href: "/#signals", label: "Signals", hash: "#signals" },
...
export function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-[#1E1E1E] bg-[#0A0A0A]/85 backdrop-blur">
            <nav>
                <div className="flex w-full items-center justify-between py-5 pr-3 pl-0 sm:px-6 md:px-12 lg:px-20 xl:px-28">
                    <Link href="/" className="flex items-center gap-2 sm:gap-3" aria-label="Monad Labs home">
                        <div className="relative h-12 w-56 shrink-0 sm:h-12 sm:w-60">
                            <Image
                    ...
                    <div className="hidden items-center gap-6 text-[0.7rem] uppercase tracking-[0.32em] text-[#666] md:flex">
                        {links.map((link) => {
                            const keyHash = link.hash ?? link.href;
                            const isActive = activeHash === keyHash;
                ...
                {isMenuOpen && (
                    <div className="mt-2 flex w-full flex-col gap-2 px-4 pb-6 text-[0.75rem] uppercase tracking-[0.32em] text-[#CFCFCF] sm:px-6 md:hidden">
